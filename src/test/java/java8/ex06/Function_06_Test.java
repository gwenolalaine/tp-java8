...
public class Function_06_Test {
    ...
    public void test_supplier_formatAge() throws Exception {
    	...
    	Supplier<Person> i  = ()-> {Person p = new Person(); p.setAge(35);return p;};
        String result = formatAge(i);
    ...
    public void test_supplier_requireNonNull() throws Exception {
        ...
        // TODO compléter le test unitaire pour qu'il soit passant
        Supplier<String> supplier = () -> {String str = "require non null object"; return str;};
